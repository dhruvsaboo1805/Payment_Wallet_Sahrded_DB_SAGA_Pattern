...
public class SagaOrchastrationImpl implements  SagaOrchastration {
    ...
    public boolean executeStep(Long sagaInstanceId, String stepName) {
        ...
        SagaStepEntity sagaStepDB = sagaStepRepository
                .findBySagaInstanceIdAndStepNameAndStatus(sagaInstanceId, stepName, StepStatus.PENDING)
                .orElse(
                        SagaStepEntity.builder().sagaInstanceId(sagaInstanceId).stepName(stepName).status(StepStatus.PENDING).build()
                );
    ...
    public void compensateSaga(Long sagaInstanceId) {
        ...
        List<SagaStepEntity> completedSteps = sagaStepRepository.findStepsBySagaInstanceIdAndStatus(sagaInstanceId , StepStatus.COMPLETED);
